...
<div x-data x-cloak x-show="reorderStatus" tableSection="reorder-buttons-wrapper" dusk="reorder-buttons-wrapper"
    @class([
        'mr-0 mr-md-2 mb-3 mb-md-0' => $component->isBootstrap4(),
        'me-0 me-md-2 mb-3 mb-md-0' => $component->isBootstrap5()
    ])
>
    <button dusk="reorder-toggle"
    ...
    >
        <span x-cloak x-show="currentlyReorderingStatus" dusk="reorder-cancel">
            @lang('Cancel')
        </span>

        <span x-cloak x-show="!currentlyReorderingStatus" dusk="reorder-save">
            @lang('Reorder')
        </span>

    </button>
    
    <button dusk="reorder-save"
        type="button"
