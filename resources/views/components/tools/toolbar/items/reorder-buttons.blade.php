...
<div x-data x-cloak x-show="reorderStatus" tableSection="reorder-buttons-wrapper"
    @class([
        'mr-0 mr-md-2 mb-3 mb-md-0' => $component->isBootstrap4(),
        'me-0 me-md-2 mb-3 mb-md-0' => $component->isBootstrap5()
    ])
>
    <button tableSection="reorder-toggle"
    ...
    >
        <span x-cloak x-show="currentlyReorderingStatus" tableSection="reorder-cancel">
            @lang('Cancel')
        </span>

        <span x-cloak x-show="!currentlyReorderingStatus" tableSection="reorder-reorder">
            @lang('Reorder')
        </span>

    </button>
    
    <button tableSection="reorder-save"
        type="button"
