...
<div @class([
    ...
    <div
        ...
        @class([
                ...
                'tw4ph inline-flex h-full items-center px-3 text-gray-500 bg-gray-50 rounded-r-md border border-l-0 border-gray-300 cursor-pointer sm:text-sm dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600' => $isTailwind4,
            ])
    >
        <x-heroicon-m-x-mark
            @class([
                'w-4 h-4' => ($isTailwind || $isTailwind4),
                'laravel-livewire-tables-btn-smaller' => $isBootstrap,
            ])
        />
    </div>
</div>
