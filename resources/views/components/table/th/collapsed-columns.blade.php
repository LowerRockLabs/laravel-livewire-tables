...
@if ($component->collapsingColumnsAreEnabled() && $component->hasCollapsedColumns())
        ...
        <th
            ...
            {{
                $attributes->merge($customAttributes)
                    ->class(['class' => 'table-cell dark:bg-gray-800 laravel-livewire-tables-reorderingMinimised'])
    ...
    @elseif ($component->isBootstrap())
        <th
            ...
            {{
                $attributes->merge($customAttributes)
                    ->class(['class' => 'd-table-cell laravel-livewire-tables-reorderingMinimised'])
